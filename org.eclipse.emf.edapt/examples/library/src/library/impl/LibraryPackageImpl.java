...
public class LibraryPackageImpl extends EPackageImpl implements LibraryPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getWriter_Name(), ecorePackage.getEString(), "name", null, 1, 1, Writer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		// Initialize enums and add enum literals
		initEEnum(bookCategoryEEnum, BookCategory.class, "BookCategory");
		addEEnumLiteral(bookCategoryEEnum, BookCategory.GUIDE_BOOK);
		addEEnumLiteral(bookCategoryEEnum, BookCategory.SPECIALIST_BOOK);
