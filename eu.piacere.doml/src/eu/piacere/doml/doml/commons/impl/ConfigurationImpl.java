 ...
 * </p>
 * <ul>
 *   <li>{@link eu.piacere.doml.doml.commons.impl.ConfigurationImpl#getDeployments <em>Deployments</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConfigurationImpl extends DOMLElementImpl implements Configuration {
	/**
	...
	protected EClass eStaticClass() {
		return CommonsPackage.Literals.CONFIGURATION;
	}
	...
	public EList<Deployment> getDeployments() {
		if (deployments == null) {
			deployments = new EObjectContainmentEList<Deployment>(Deployment.class, this, CommonsPackage.CONFIGURATION__DEPLOYMENTS);
		}
		return deployments;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CommonsPackage.CONFIGURATION__DEPLOYMENTS:
