 ...
 * </p>
 * <ul>
 *   <li>{@link eu.piacere.doml.doml.commons.impl.PropertyImpl#getKey <em>Key</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PropertyImpl extends EObjectImpl implements Property {
	...
	protected EClass eStaticClass() {
		return CommonsPackage.Literals.PROPERTY;
	}
	...
	public void setKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommonsPackage.PROPERTY__KEY, oldKey, key));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CommonsPackage.PROPERTY__KEY:
				return getKey();
		}
