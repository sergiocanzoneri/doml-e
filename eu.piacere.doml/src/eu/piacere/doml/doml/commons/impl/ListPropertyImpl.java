 ...
 * </p>
 * <ul>
 *   <li>{@link eu.piacere.doml.doml.commons.impl.ListPropertyImpl#getValues <em>Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ListPropertyImpl extends PropertyImpl implements ListProperty {
	 ...
	 * @ordered
	 */
	protected EList<Property> values;
	...
	protected EClass eStaticClass() {
		return CommonsPackage.Literals.LIST_PROPERTY;
	}
	...
	public EList<Property> getValues() {
		if (values == null) {
			values = new EObjectContainmentEList<Property>(Property.class, this, CommonsPackage.LIST_PROPERTY__VALUES);
		}
		return values;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CommonsPackage.LIST_PROPERTY__VALUES:
