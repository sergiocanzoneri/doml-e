 ...
 * </p>
 * <ul>
 *   <li>{@link eu.piacere.doml.doml.application.impl.ApplicationLayerImpl#getComponents <em>Components</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ApplicationLayerImpl extends DOMLElementImpl implements ApplicationLayer {
	/**
	...
	protected EClass eStaticClass() {
		return ApplicationPackage.Literals.APPLICATION_LAYER;
	}
	...
	public EList<ApplicationComponent> getComponents() {
		if (components == null) {
			components = new EObjectContainmentEList<ApplicationComponent>(ApplicationComponent.class, this, ApplicationPackage.APPLICATION_LAYER__COMPONENTS);
		}
		return components;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ApplicationPackage.APPLICATION_LAYER__COMPONENTS:
